...
class TrainDataset(Dataset):
    def __init__(self, dataset_dir, crop_size, upscale_factor):
        ...
        self.hr_preprocess = Compose([CenterCrop(512), RandomCrop(crop_size), ToTensor()]) #from 384 to 512
...
class DevDataset(Dataset):
	...
	def __getitem__(self, index):
		...
		crop_size = calculate_valid_crop_size(512, self.upscale_factor) #from 128 to 512
